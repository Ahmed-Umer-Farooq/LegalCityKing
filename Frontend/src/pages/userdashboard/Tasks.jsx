    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-100">
        <div className="p-3 lg:p-4 border-b border-gray-100">
          <h2 className="text-base lg:text-lg font-semibold text-gray-900">Your Tasks ({filteredTasks.length})</h2>
        </div>
        <div className="divide-y divide-gray-100">
          {loading ? (
            ...
            tasks.map(task => (
              <div key={task.secure_id} className={`p-3 lg:p-4 hover:bg-gray-50 transition-colors ${task.status === 'completed' ? 'opacity-75' : ''}`}>
