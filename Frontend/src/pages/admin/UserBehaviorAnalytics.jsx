    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">User engagement and behavior patterns</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm font-semibold text-gray-600">Total Cases</span>
          </div>
          <div className="text-3xl font-bold text-gray-900">{analytics.featureUsage.totalCases.toLocaleString()}</div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          ...
          <div className="text-3xl font-bold text-gray-900">{analytics.featureUsage.messages30d.toLocaleString()}</div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm font-semibold text-gray-600">Blog Posts</span>
          </div>
          <div className="text-3xl font-bold text-gray-900">{analytics.featureUsage.blogs30d.toLocaleString()}</div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm font-semibold text-gray-600">Q&A</span>
          </div>
          <div className="text-3xl font-bold text-gray-900">{analytics.featureUsage.questions30d.toLocaleString()}</div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm font-semibold text-gray-600">Appointments</span>
          </div>
          <div className="text-3xl font-bold text-gray-900">{analytics.featureUsage.appointments30d.toLocaleString()}</div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900">User Engagement by Role</h3>
            <p className="text-sm text-gray-600">Active users and engagement metrics</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900">Login Activity by Hour</h3>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">User activity status</p>
            </div>
          </div>
